    ...
    <form onsubmit={ submit }>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" id="price" placeholder="Price per unit" required="true" value={ product.unitPrice } readonly={ !editMode }>
            </div>
        </div>
        <div class="form-row">
            <div class="form-group col-md-12">
                <label for="stock">Available in stock</label>
                <input type="text" class="form-control" id="stock" placeholder="Value" required="true" value={ product.stock } readonly={ !editMode }>
            </div>
        </div>
